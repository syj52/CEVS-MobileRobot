...
void MX_UART4_Init(void)
{
  ...
  */
  ...
  /*
   * è¦†ç›– CubeMX é»˜è®¤æ³¢ç‰¹çŽ?: IMU éœ?è¦? 115200, LL åº“ä¸è‡ªåŠ¨å¼? RXNE ä¸­æ–­ã€?
   * LL_USART_SetBaudRate éœ?è¦? PCLK1 é¢‘çŽ‡, STM32F103 ä¸? PCLK1=HCLK/2=36MHzã€?
   */
  LL_USART_Disable(UART4);
  LL_USART_SetBaudRate(UART4, 36000000, 115200);
